...
func newQuestion(db *gorm.DB, opts ...gen.DOOption) question {
	...
	_question.Type = field.NewInt32(tableName, "type")
	_question.UpdateAt = field.NewTime(tableName, "update_at")
	_question.CreateAt = field.NewTime(tableName, "create_at")
...
type question struct {
	...
	ALL      field.Asterisk
	ID       field.Int64  // 主键ID
	Title    field.String // 问题标题
	Content  field.String // 问题详细内容
	Type     field.Int32  // 问题类型：1-单选题，2-多选题，3-填空题，4-问答题，5-判断题
...
func (q *question) updateTableName(table string) *question {
	...
	q.UpdateAt = field.NewTime(table, "update_at")
	q.CreateAt = field.NewTime(table, "create_at")
...
func (q *question) fillFieldMap() {
	...
	q.fieldMap["update_at"] = q.UpdateAt
	q.fieldMap["create_at"] = q.CreateAt
}
